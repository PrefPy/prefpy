...
def plot_error_time_data(str_error_type,          # string, title of the error measure in use
    ...
    emm_new1, = plt.plot(error_results.T[0], error_results.T[1], "yp", label="EMM-redo")
    plt.subplot(122)
    ...
    plt.plot(time_results.T[0], time_results.T[1], "yp", label="EMM-redo")
    fig.legend([gmm_line, emm_line, emm_new1], ["GMM", "EMM", "EMM-redo"], loc="center right")
